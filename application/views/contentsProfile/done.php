...
<div class="row">
    <div class=" col-xs-12 col-sm-6 col-md-3">
        ...
        <div class="thumbnail">
            ...
            <img src="<?= base_url('assets/img/avatar-2.png'); ?>" alt="img" class="img-circle pull-right admin-img">
            <div class="caption">
                <h3>Task Title</h3>
                <p>
                ...
                <p><a href="#" class="btn btn-srch" role="button">to Must Do</a> <a href="#" class="btn btn-trash" role="button">in trash</a></p>
            </div>
        </div>
        <!-- </button> -->
    </div>
